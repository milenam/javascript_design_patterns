// The singleton pattern is thus known because traditionally,
...
// instantiation of the singleton when it's needed

var Singleton = (function () {
	var instantiated;
  function init() { // singleton here
  	return {
      publicMethod: function () {
      	console.log('hello world');
      },
...
// options: an object containing configuration options for the singleton // e.g
